...
import { Eye, X, Download, Trash2, Filter, Search, Calendar, User, Mail, Phone, BookOpen, Clock } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex items-center gap-4">
            ...
            <div>
              <div className="text-2xl font-bold text-gray-900">{classInquiries.length}</div>
          ...
          <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 flex items-center gap-4">
            ...
            <div>
              <div className="text-2xl font-bold text-gray-900">
                {classInquiries.filter(i => i.status === 'Converted' || i.status === 'Enrolled').length}
              </div>
            ...
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-100">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Class Details</th>
